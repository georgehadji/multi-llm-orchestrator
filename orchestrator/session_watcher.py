...
class SessionWatcher:
    ...
    def start_session(self, project_id: str, metadata: Optional[Dict[str, Any]] = None) -> str:
    ...
    def end_session(self, project_id: str) -> Optional[str]:
    ...
    def get_active_session(self, project_id: str) -> Optional[str]:
    ...
    def get_session_stats(self, project_id: Optional[str] = None) -> Dict[str, Any]:
...
_default_watcher: Optional[SessionWatcher] = None
