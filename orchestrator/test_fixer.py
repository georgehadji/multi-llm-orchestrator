...
class TestFixer:
        ...
        with self.tracer.start_as_current_span("fix_failing_tests") as span:
            ...
            for iteration in range(1, max_iterations + 1):
                ...
                if pass_rate >= min_pass_rate or current_failed == 0:
                    print(f"✅ Target pass rate achieved!")
                    report.success = True
                ...
                fix_attempts = await self._attempt_fixes(
                    project_path_obj, failures, iteration
                )
    ...
    def _guess_source_file(self, project_path: Path, test_name: str) -> Optional[str]:
