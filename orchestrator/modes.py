...
class ModeConfig:
    ...
    model_override: Optional[Model]  # Override default model selection
...
class ModeManager:
    ...
    def apply_mode_to_params(self, params: Dict[str, Any], mode: Optional[OperationMode] = None) -> Dict[str, Any]:
        """
    ...
    def get_model_for_mode(self, mode: Optional[OperationMode] = None) -> Model:
        """
    ...
    def adjust_validation_level(self, mode: Optional[OperationMode] = None) -> str:
        """
    ...
    def get_creativity_boost(self, mode: Optional[OperationMode] = None) -> float:
        """
