...
from .knowledge_base import KnowledgeBase, KnowledgeArtifact, KnowledgeType
from .plugins import get_plugin_registry, FeedbackPayload, FeedbackPlugin
...
class FeedbackLoop:
    ...
    def _get_codebase_adjusted_score(
        ...
        for fp_hash, outcomes in self._codebase_outcomes.items():
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "unique_models": len(set(r.model for r in self._performance_records.values())),
