...
class Feature:
    ...
    revenue_impact: float | None = None  # Predicted revenue impact
...
class FeatureFlagManager:
    ...
    def is_enabled(self, flag_id: str, user_id: str | None = None) -> bool:
...
class ProductManager:
    ...
    def get_prioritized_backlog(
        self,
        status_filter: FeatureStatus | None = None,
        limit: int = 20,
    ) -> list[Feature]:
    ...
    def get_feedback_summary(self, feature_id: str | None = None) -> dict[str, Any]:
    ...
    def is_feature_enabled(self, feature_id: str, user_id: str | None = None) -> bool:
        """Check if feature is enabled for user."""
...
def get_product_manager(storage_path: Path | None = None) -> ProductManager:
