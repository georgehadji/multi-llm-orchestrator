...
class IntegrationCircuitBreaker:
    ...
    def __init__(
        ...
        self._states: dict[IntegrationType, IntegrationState] = {
            t: IntegrationState.CLOSED for t in IntegrationType
        }
        self._failures: dict[IntegrationType, int] = {
            t: 0 for t in IntegrationType
        }
        self._last_failure: dict[IntegrationType, Optional[datetime]] = {
            t: None for t in IntegrationType
        }
        self._last_success: dict[IntegrationType, Optional[datetime]] = {
            t: None for t in IntegrationType
        }
        self._half_open_calls: dict[IntegrationType, int] = {
            t: 0 for t in IntegrationType
        }
        self._error_messages: dict[IntegrationType, Optional[str]] = {
            t: None for t in IntegrationType
        }
