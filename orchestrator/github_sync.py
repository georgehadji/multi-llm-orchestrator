...
class GitHubSync:
    ...
    def _get_config(self, repo_url: Optional[str]) -> Optional[SyncConfig]:
...
_default_sync: Optional[GitHubSync] = None


def get_github_sync(token: Optional[str] = None) -> GitHubSync:
