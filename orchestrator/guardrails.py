...
class ProductionGuardrails:
    ...
    def __init__(self, config: GuardrailConfig | None = None):
        ...
        # Callbacks
        self._on_budget_warning: Callable | None = None
        self._on_budget_critical: Callable | None = None
        self._on_kill_switch: Callable | None = None
        self._on_error_rate_exceeded: Callable | None = None
...
# Singleton instance
_guardrails: ProductionGuardrails | None = None
