...
) -> Optional["MetaOptimizationV2Wrapper"]:
    """
...
class MetaOptimizationV2Wrapper:
    ...
    async def record_project_completion(self, state: Any):
        ...
        try:
            from .meta_orchestrator import ProjectTrajectory, ExecutionRecord
...
async def on_task_completed(
    meta_wrapper: Optional[MetaOptimizationV2Wrapper],
    task_id: str,
    result: Any,
):
    """
...
def get_meta_status(meta_wrapper: Optional[MetaOptimizationV2Wrapper]) -> dict:
    """
