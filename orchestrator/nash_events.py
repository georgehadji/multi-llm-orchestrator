...
from typing import Any, Dict, List, Optional, Callable, Type, Set, Coroutine
...
class NashEventBus:
    ...
    def __init__(self, storage_path: Optional[Path] = None, persist_events: bool = True):
...
class NashEventHandlers:
    ...
    async def _on_knowledge_graph_updated(self, event: KnowledgeGraphUpdatedEvent):
        ...
        if event.nodes_added > 5 or event.edges_added > 10:
            if self.frontier:
...
_event_bus: Optional[NashEventBus] = None
