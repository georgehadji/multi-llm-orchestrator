...
from .component_library import ComponentLibrary, Component, ComponentType
from .deployment_service import DeploymentService, DeploymentTarget, DeploymentResult
from .github_sync import GitHubSync, SyncConfig, SyncDirection
from .fullstack_generator import FullStackGenerator, FullStackApp, GenerationOptions
from .api_builder import APIIntegrationBuilder, APIIntegration
from .preview_server import PreviewServer, PreviewConfig
from .database_generator import DatabaseSchemaGenerator, DatabaseSchema, DatabaseType
...
class SwiftStackIntegration:
    ...
    def __init__(self, config: Optional[SwiftStackConfig] = None):
        """
        ...
        self.component_library: Optional[ComponentLibrary] = None
        self.deployment_service: Optional[DeploymentService] = None
        self.github_sync: Optional[GitHubSync] = None
        self.fullstack_generator: Optional[FullStackGenerator] = None
        self.api_builder: Optional[APIIntegrationBuilder] = None
        self.preview_server: Optional[PreviewServer] = None
        self.database_generator: Optional[DatabaseSchemaGenerator] = None
...
_default_integration: Optional[SwiftStackIntegration] = None


def get_swiftstack_integration(
    config: Optional[SwiftStackConfig] = None,
