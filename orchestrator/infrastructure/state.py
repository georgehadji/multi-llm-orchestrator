            ...
            async with self._lock:
                if self._conn is None:
                    ...
                    try:
                        ...
                        # connection instead of opening a second sync connection.
                        # This avoids "database is locked" errors from competing
                        # sqlite3 handles on the same WAL-mode database.
                        for col in ("project_description", "keywords_json"):
                            try:
