...
class DiffGenerator:
    ...
    def _validate_patched_code(self, code: str, task_type: TaskType) -> Optional[str]:
        """
...
def apply_unified_diff(original_code: str, diff_text: str) -> Tuple[str, Optional[str]]:
    """
...
def _apply_diff_line_by_line(code: str, diff_text: str) -> Tuple[str, Optional[str]]:
    """
