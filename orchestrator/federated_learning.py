...
from .feedback_loop import CodebaseFingerprint, ProductionOutcome, OutcomeStatus
...
class FederatedLearningOrchestrator:
    ...
    async def _generate_baseline(
        ...
        # Count unique orgs
        unique_orgs = len(set(i.org_hash for i in relevant))
    ...
    async def _run_aggregation(self) -> None:
        ...
        unique_orgs = len(set(i.org_hash for i in self._global_insights))
    ...
    def get_switching_cost_estimate(self) -> Dict[str, Any]:
        ...
        global_contributing_orgs = len(set(i.org_hash for i in self._global_insights))
        ...
        unique_patterns = len(set(i.pattern_signature for i in self._local_insights))
...
_federated: Optional[FederatedLearningOrchestrator] = None
