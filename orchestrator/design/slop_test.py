...
class SlopTestResult:
    ...
    def critical_failures(self) -> list[GateFinding]:
        return [f for f in self.findings if f.gate.severity == GateSeverity.CRITICAL and not f.override_applied]

    @property
    def major_failures(self) -> list[GateFinding]:
        return [f for f in self.findings if f.gate.severity == GateSeverity.MAJOR and not f.override_applied]

    @property
    def minor_findings(self) -> list[GateFinding]:
        return [f for f in self.findings if f.gate.severity == GateSeverity.MINOR and not f.override_applied]
...
_DEFAULT_GATES: list[Gate] = [
    # ── Visual gates ──────────────────────────────────────────────────────────
    Gate(1, "visual", "Banned display font", GateSeverity.CRITICAL,
         lambda o, g: bool(_RE_BANNED_FONT.search(o)),
         {},
         "Inter, Roboto, Open Sans, Poppins, Lato used as display font"),
    Gate(2, "visual", "Purple-to-blue gradient", GateSeverity.CRITICAL,
    ...
    Gate(7, "visual", "Centred everything hero", GateSeverity.MAJOR,
    ...
    Gate(22, "implementation", "Pure grey OKLCH neutrals", GateSeverity.MAJOR,
    ...
    Gate(23, "implementation", "Accent flood", GateSeverity.MAJOR,
    ...
    Gate(24, "implementation", "Arbitrary spacing values", GateSeverity.MINOR,
         lambda o, g: bool(_RE_ARBITRARY_SPACING.search(o)),
         {},
         "Padding / gap / margin not on 4px spacing scale"),
    Gate(25, "implementation", "Prose container width out of range", GateSeverity.MAJOR,
         lambda o, g: False,  # Requires numeric parsing
         {},
         "max-width outside 45-75ch range"),
    Gate(26, "implementation", "Missing interactive states", GateSeverity.CRITICAL,
    ...
    Gate(27, "implementation", "Missing prefers-reduced-motion", GateSeverity.MAJOR,
    ...
    Gate(28, "hero", "Lazy-loaded LCP element", GateSeverity.CRITICAL,
         lambda o, g: bool(_RE_LAZY_LCP.search(o)),
         {},
         "loading=\"lazy\" on hero image or video (LCP killer)"),
    Gate(29, "hero", "Abstract background flood", GateSeverity.MAJOR,
    ...
    Gate(53, "chrome", "Re-drawn UI chrome", GateSeverity.MAJOR,
