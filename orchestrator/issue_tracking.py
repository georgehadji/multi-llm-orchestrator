...
class BacklogSyncService:
    ...
    def __init__(
        ...
        rice_config: RICEMappingConfig | None = None,
    ):
...
class TicketKnowledgeSync:
    ...
    def __init__(
        ...
        llm_summarizer: Callable[[str, str], str] | None = None,
    ):
        self.tracker = tracker
...
class TicketSyncHooks:
    ...
    async def on_quality_gate_evaluated(self, report: QualityGateReport) -> str | None:
        """
