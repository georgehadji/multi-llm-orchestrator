...
class QualityReport:
    ...
    def passed(self) -> bool:
        ...
        return not (avg_coverage is not None and avg_coverage < 80)
...
class QualityController:
    ...
    def __init__(self, storage_path: Path | None = None):
        ...
        self._baseline: QualityReport | None = None
    ...
    async def run_quality_gate(
        ...
        project_id: str,
        project_path: Path,
        levels: list[TestLevel] | None = None,
    ) -> QualityReport:
        """
...
def get_quality_controller(storage_path: Path | None = None) -> QualityController:
