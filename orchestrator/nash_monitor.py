...
class StabilityThreshold:
    ...
    def record(self, value: float, metadata: dict | None = None):
...
class NashRuntimeMonitor:
    ...
    def __init__(
        ...
        self._io_manager: AsyncIOManager | None = None
        self._wal: WriteAheadLog | None = None
        self._event_bus: UnifiedEventBus | None = None
    ...
    def register_components(
        self,
        io_manager: AsyncIOManager | None = None,
...
_global_monitor: NashRuntimeMonitor | None = None
