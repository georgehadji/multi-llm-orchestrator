...
class QueryOptimizer:
    ...
    # Allowlist of tables and columns this query builder is permitted to reference.
    # Extend here as new tables are added — never accept table/column names from
    # user input without adding them to this set first.
