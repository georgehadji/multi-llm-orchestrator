...
class SecureCache:
    ...
    async def get(self, key: str, default: Any = None) -> Any:
        ...
        try:
            ...
            # Deserialize
            if compressed:
                value_str = self._decompress(value_blob)
            else:
                value_str = value_blob
...
_default_cache: Optional[SecureCache] = None


def get_secure_cache(db_path: Optional[Path] = None) -> SecureCache:
