...
class DashboardView(ABC):
    ...
    def handle_event(self, event: DomainEvent) -> dict[str, Any] | None:
        """
...
class ViewRegistry:
    ...
    def get(self, name: str) -> DashboardView | None:
        """Get a view by name."""
    ...
    def get_default(self) -> DashboardView | None:
...
class DashboardCore:
    ...
    _instance: DashboardCore | None = None
    _lock = asyncio.Lock()
