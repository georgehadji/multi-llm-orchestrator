...
@register(TaskType.ARCHITECTURE)
class ArchitectureHandler(_BaseHandler):
    """Handler for architecture advisory tasks."""
    ...
    async def execute(
        ...
        **kwargs,
        ...
        text = await self._call_llm(
            client,
            task.prompt,
            system="You are a senior software architect. Provide clear architectural guidance.",
            model=model,
            max_tokens=task.max_output_tokens,
            temperature=0.3,
            timeout=180,
