...
class EnhancedDataProvider:
    ...
    def __init__(self):
        ...
        self._architecture_rules: Optional[ArchitectureInfo] = None
        self._active_task: Optional[ActiveTaskInfo] = None
        
        # Model health tracking
        self._model_health: Dict[Model, Dict[str, Any]] = {}
        self._consecutive_failures: Dict[Model, int] = {m: 0 for m in Model}
    
    def set_current_project(self, project_id: str, state: Any, architecture_rules: Optional[Any] = None):
    ...
    def set_active_task(self, task_id: str, task: Any, model: Optional[Model] = None):
    ...
    async def get_architecture_info(self) -> Optional[Dict[str, Any]]:
...
class DashboardIntegration:
    ...
    def on_project_start(self, project_id: str, state: Any, architecture_rules: Optional[Any] = None):
        """Call when project starts."""
        self.data_provider.set_current_project(project_id, state, architecture_rules)
    
    def on_task_start(self, task_id: str, task: Any, model: Optional[Model] = None):
