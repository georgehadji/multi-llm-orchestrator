...
from .ab_testing import ABTestingEngine, Experiment, Recommendation
from .hitl_workflow import HITLWorkflow, ApprovalConfig, ApprovalRequest, ApprovalStatus, ImpactLevel
...
class MetaOptimizationV2:
    ...
    def __init__(
        ...
        config: Optional[MetaV2Config] = None,
    ):
        ...
        self.ab_testing: Optional[ABTestingEngine] = None
        self.hitl: Optional[HITLWorkflow] = None
        self.rollout: Optional[GradualRolloutManager] = None
    ...
    async def _evaluate_proposal(self, proposal: StrategyProposal) -> ProposalOutcome:
        ...
        if (impact_level == ImpactLevel.STRUCTURAL and
            ...
            return ProposalOutcome(
                ...
                reason=f"Structural change requires approval",
            )
    ...
    async def check_hitl_status(self, request_id: str) -> Optional[ProposalOutcome]:
        """
        ...
        if request.status == ApprovalStatus.APPROVED:
            ...
            if self.rollout:
                ...
                return ProposalOutcome(
                    ...
                    decision=ProposalDecision.SENT_TO_ROLLOUT,
                    rollout_id=rollout.rollout_id,
                    reason=f"HITL approved, starting rollout",
                )
...
_meta_v2: Optional[MetaOptimizationV2] = None


def get_meta_optimization_v2() -> Optional[MetaOptimizationV2]:
