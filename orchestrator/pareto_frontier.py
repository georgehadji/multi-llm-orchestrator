...
from .models import Model, TaskType, COST_TABLE
...
class CostQualityFrontier:
    ...
    def __init__(
        ...
        leaderboard: Optional[ModelLeaderboard] = None,
    ...
    async def get_pareto_frontier(
        ...
        fingerprint: Optional[CodebaseFingerprint] = None,
    ...
    async def _predict_all_models(
        self,
        task_type: TaskType,
        fingerprint: Optional[CodebaseFingerprint],
        objectives: List[Objective],
    ...
    def _estimate_latency(self, model: Model) -> float:
        ...
        latency_table = {
            ...
            Model.MINIMAX_TEXT_01: 1500,
            Model.KIMI_K2_5: 1800,
            Model.GPT_4O: 2500,
        ...
        while remaining:
            ...
            for idx in frontier:
                ...
                for other_idx in remaining:
                    ...
                    ] or points[idx].prediction.model.value in [
                        d for d in points[other_idx].dominates
                    ]:
    ...
    def _generate_recommendations(
        ...
        for i, point in enumerate(pareto_points):
            ...
            if point.pareto_rank == 0:
                ...
                recommendation = f"High-confidence choice with proven performance"
            elif pred.cost < 0.005:
                recommendation = f"Budget-friendly option"
            else:
                recommendation = f"Alternative with different trade-offs"
...
_frontier: Optional[CostQualityFrontier] = None
