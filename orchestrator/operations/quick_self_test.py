...
def main() -> None:
    # Log to a temp dir, not the source tree (hunt T16 — this used to write
    # self_test_log.txt into orchestrator/ itself on every run).
    log_file = os.path.join(tempfile.gettempdir(), "orchestrator_self_test_log.txt")
