...
class PerformanceConfig:
    ...
    max_memory_mb: Optional[float] = None  # None = unlimited
...
_default_config: Optional[MetaOptimizationConfig] = None


def get_config(path: Optional[Path] = None) -> MetaOptimizationConfig:
    """
