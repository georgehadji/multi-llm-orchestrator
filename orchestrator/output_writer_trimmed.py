...
def _write_readme(
    ...
    lines += [
        ...
        "",
        "The following files provide an integrated, runnable project structure:",
        "",
        "- `main.py` — Entry point that runs all modules in sequence",
        "- `config.py` — Project configuration and paths",
        "- `pyproject.toml` — Modern Python packaging with dependencies",
        "- `Makefile` — Common tasks (install, run, test, lint)",
        "",
        "### Quick Start",
        "",
        "```bash",
