...
from ..engine_core.modes import ModeConfig, ModeManager, OperationMode
...
class PersonaModeManager:
    ...
    def get_creativity_boost(self, persona: Persona | None = None) -> float:
        """
    ...
    def get_persona_characteristics(self, persona: Persona | None = None) -> dict[str, Any]:
        """
