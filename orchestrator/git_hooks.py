...
from orchestrator.models import ProjectState, TaskResult, TaskType, ProjectStatus
...
class GitIntegrationHooks:
    ...
    async def on_run_complete(
        ...
        try:
            ...
            conclusion = (
                CheckRunConclusion.SUCCESS if quality_passed 
...
"""
            ...
            title = (
                "AI Orchestrator: PASSED ✅" if quality_passed 
                else "AI Orchestrator: FAILED ❌"
            )
