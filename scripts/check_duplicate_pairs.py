...
BASELINE: set[str] = {
    ...
    "generators/docker_generator.py",
    ...
    "infrastructure/query_expander.py",
    "infrastructure/reranker.py",
    "infrastructure/streaming.py",
    "integrations/gateway.py",
    ...
    "operations/export_manager.py",
    "operations/feedback_loop.py",
    "operations/gradual_rollout.py",
    "operations/remediation.py",
    "product/product_manager.py",
    "project_mgmt/assembler.py",
    "quality/advanced_query_processing.py",
    "quality/pre_submission_testing.py",
