...
core_files = [
    ...
    "agent/__init__.py", "agent/agent_runtime_helpers.py",
    "agent/conversation_loop.py", "agent/tool_executor.py",
    "agent/skill_utils.py", "agent/memory_manager.py",
    "agent/system_prompt.py", "agent/context_engine.py",
    "agent/prompt_builder.py", "agent/trajectory.py",
...
for f in core_files:
    ...
    if os.path.exists(src):
        name = "hermes_" + f.replace("/", "_").replace("\\", "_")
