...
Standalone orchestrator-persona package for AI agent behavioral modes.
"""
...
logger = logging.getLogger("orchestrator_persona.persona")
...
class PersonaMode(Enum):
    ...
    PONYTAIL = "ponytail"  # Minimalist, lazy senior dev mode
...
class Persona:
    ...
    PRESETS = {
        ...
        PersonaMode.PONYTAIL: PersonaSettings(
            temperature=0.1,
            top_p=0.1,
            top_k=10,
            strict_validation=True,
            ...
            system_prompt_addition="You are Ponytail, a lazy senior developer. Write the absolute minimum code required. Stop at the first rung of The Ladder: YAGNI -> stdlib -> native -> existing dep -> one line. Mark intentional simplifications with 'ponytail:' comments. Keep explanations to a maximum of three short lines.",
        ),
    }
