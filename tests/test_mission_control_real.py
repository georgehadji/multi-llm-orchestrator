...
print("\n4. Testing ProjectRunner with hooks...")
try:
    ...
    try:
        ...
        print(f"   [WARN] Hook registration skipped: {add_err}")

    if hooked:
        print("   [OK] Hook registry works")
    else:
        print("   [INFO] Hook registry not exercised")
except Exception as e:
    print(f"   [ERROR] Failed: {e}")
    import traceback
    traceback.print_exc()
...
print("\n" + "=" * 70)
print("[OK] Mission Control v6.0 with REAL Orchestrator is READY!")
print("=" * 70)
print("""
To start:
