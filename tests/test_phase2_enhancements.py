...
class TestCrossProjectLearning:
    ...
    def test_aggregate_model_task_scores(self, learning):
        ...
        traces = [
            {
                "tasks": [
                    {"model_used": "claude-sonnet-4.6", "type": "code_generation", "score": 0.85, "cost_usd": 0.02, "tokens_used": {"output": 1000}},
                    {"model_used": "deepseek-v3.2", "type": "code_generation", "score": 0.78, "cost_usd": 0.01, "tokens_used": {"output": 1000}},
                    {"model_used": "claude-sonnet-4.6", "type": "code_generation", "score": 0.88, "cost_usd": 0.02, "tokens_used": {"output": 1000}},
                ]
            },
            {
                "tasks": [
                    {"model_used": "deepseek-v3.2", "type": "code_generation", "score": 0.82, "cost_usd": 0.01, "tokens_used": {"output": 1000}},
                    {"model_used": "claude-sonnet-4.6", "type": "code_review", "score": 0.90, "cost_usd": 0.02, "tokens_used": {"output": 500}},
                ]
            },
        ]
    ...
    def test_extract_failure_patterns(self, learning):
        ...
        traces = [
            {
                "tasks": [
                    {"prompt": "Implement authentication with JWT", "score": 0.5, "status": "FAILED"},
                    {"prompt": "Implement authentication with OAuth", "score": 0.6, "status": "FAILED"},
                    {"prompt": "Implement authentication system", "score": 0.55, "status": "FAILED"},
    ...
    def test_correlate_size_repairs(self, learning):
        ...
        traces = [
            {
                "tasks": [
                    {"iterations": 1}, {"iterations": 1}, {"iterations": 1},  # Small project, 0 repairs
                ]
            },
            {
                "tasks": [
                    {"iterations": 1}, {"iterations": 2}, {"iterations": 1},  # Medium project, 1 repair
                    {"iterations": 1}, {"iterations": 1},
                ]
            },
            {
                "tasks": [
                    {"iterations": 2}, {"iterations": 3}, {"iterations": 2},  # Large project, 3 repairs
                    {"iterations": 1}, {"iterations": 2}, {"iterations": 1},
                    {"iterations": 3}, {"iterations": 2}, {"iterations": 1},
                ]
            },
        ]
    ...
    async def test_extract_insights(self, learning):
        ...
        traces = [
            {
                "tasks": [
                    {"model_used": "claude-sonnet-4.6", "type": "code_generation", "prompt": "Create API", "score": 0.9, "cost_usd": 0.02, "tokens_used": {"output": 1000}, "iterations": 1, "status": "COMPLETED"},
                    {"model_used": "claude-sonnet-4.6", "type": "code_generation", "prompt": "Create API 2", "score": 0.88, "cost_usd": 0.02, "tokens_used": {"output": 1000}, "iterations": 1, "status": "COMPLETED"},
                    {"model_used": "claude-sonnet-4.6", "type": "code_generation", "prompt": "Create API 3", "score": 0.92, "cost_usd": 0.02, "tokens_used": {"output": 1000}, "iterations": 1, "status": "COMPLETED"},
                    {"model_used": "claude-sonnet-4.6", "type": "code_generation", "prompt": "Create API 4", "score": 0.87, "cost_usd": 0.02, "tokens_used": {"output": 1000}, "iterations": 1, "status": "COMPLETED"},
                    {"model_used": "claude-sonnet-4.6", "type": "code_generation", "prompt": "Create API 5", "score": 0.89, "cost_usd": 0.02, "tokens_used": {"output": 1000}, "iterations": 1, "status": "COMPLETED"},
                ]
            },
