...
class TestPreSubmissionTester:
    ...
    def test_calculate_approval_probability(self, tester):
        ...
        # Mixed results
        results_mixed = [
            CheckResult(check_type=CheckType.BUILD_VERIFICATION, passed=True, message="OK", severity="critical"),
            CheckResult(check_type=CheckType.COMPLETENESS, passed=False, message="Fail", severity="critical"),
        ]
