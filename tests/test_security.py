...
class TestCORSPolicy:
    ...
    def test_cors_allowlist_configurable(self):
        ...
        assert (
            "cors_origins: Optional[List[str]]" in content or "cors_origins=None" in content
...
class TestRateLimiting:
    ...
    def test_rate_limiter_exists(self):
        ...
        assert (
            "TokenBucketRateLimiter" in content or "RateLimiter" in content
    ...
    def test_rate_limiting_applied(self):
        ...
        assert (
            "rate_limit" in content.lower() or "is_allowed" in content
...
class TestInputValidation:
    ...
    def test_code_validator_exists(self):
        ...
        assert (
            "ASTSecurityAnalyzer" in content or "validate_code" in content
    ...
    def test_no_env_in_git(self):
        ...
        try:
            result = subprocess.run(
                ["git", "ls-files", "*.env"], capture_output=True, text=True, timeout=10
            )
