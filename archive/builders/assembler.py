...
# FIXED: from .output_writer import _ext_for, _render_content, _strip_fences
from ...output_writer import _ext_for, _render_content, _strip_fences

if TYPE_CHECKING:
# FIXED: from .models import ProjectState, TaskType
...
# FIXED: from .secure_execution import CommandInjectionError, SecureSubprocess
